...
export const PROPERTIES = [
  ...
  { id: 2, name: "", message: "Instala la tecnología que convierte el tráfico en datos reales.", type: "chance" as const, color: "bg-yellow-100", title_color: 'none', icon: <PngIcon src="/icons/gettin_router_icon.png" alt="Descuento" className="w-full h-full" /> },
  ...
  { id: 6, name: "VAS A LA CARCEL", message: "Están remodelando las calles aledañas a tu tienda y nadie pasó por ahí", type: "corner" as const, color: "bg-blue-200", title_color: 'none', icon: <PngIcon src="/icons/carcel_icon.png" alt="Atracción" className="w-8 h-8" /> },
  ...
  { id: 10, position_title: "bottom", name: "IMPUESTO AL MAL DATO", message: "No optimizaste tu operación y los gastos aumentaron.", type: "corner" as const, color: "bg-indigo-200", title_color: 'none', icon: <PngIcon src="/icons/impuesto_icon.png" alt="Atracción" className="w-8 h-8" /> },
  ...
  { id: 16, position_title: "bottom", name: "ESTACIONAMIENTO", message: "¡Oh no! Perdiste el boleto y el centro comercial te cobra la tarifa completa.", type: "corner" as const, color: "bg-yellow-200", title_color: 'none', icon: <PngIcon src="/icons/estacionamiento_icon.png" alt="Estacionamiento" className="w-8 h-8" /> },
